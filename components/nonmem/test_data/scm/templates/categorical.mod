$PROBLEM scm template (categorical effect)
; candidates: WT_CL CRCL_CL WT_V SEX_CL
$INPUT ID TIME AMT DV WT CRCL AGE SEX
...
ELSE
  SEX_CL = 1
ENDIF
CL = THETA(1) * WT_CL * CRCL_CL * SEX_CL * EXP(ETA(1))
