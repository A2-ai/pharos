...
$DATA /data/user-homes/matthews/Demo/hyperion-demo/data/derived/PK_Oral_Ex1.csv
  IGNORE=@
...
$OMEGA
 0.1          ;11 IIV CL ;lognormal
 0.054          ;22 IIV VC ;lognormal
 0.132          ;33 IIV KA ;lognormal
