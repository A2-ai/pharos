...
$OMEGA
0.1481446     ;OM1 TVCL :EXP
0.0881638     ;OM2 TVV :EXP
0.15649       ;OM3 TVKA :EXP

$SIGMA
0.03526006    ;SIG1 Proportional error (variance, 20% CV)
0.00582      ;SIG2 Additive error (variance, 0.01 mg/L SD)
