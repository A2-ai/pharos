$PROBLEM From bbr: see 1a013d01.yaml for details
...
$DATA ../../data/derived/1a013d01.csv
IGNORE = @
...
NOPRINT ONEHEADERALL FILE=1a013d01.tab

$TABLE NUM ID  KA CL VC=V2 WTCL COVWTCL WTV COVWTV SEXV COVSEXV  ETAS(1:LAST)
NOPRINT NOAPPEND ONEHEADER FILE=1a013d01par.tab
