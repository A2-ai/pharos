$PROBLEM From bbr: see 1a016d01.yaml for details
...
$DATA ../../data/derived/1a016d01.csv
IGNORE = @
...
;--- COVARIATES -----------------------
    ...
    ADMKA = 0
    IF(ADMS.EQ.1) ADMKA = THETA(4)  ; Type Administration or Site
    COVADMKA=EXP(ADMKA)
...
NOPRINT ONEHEADERALL FILE=1a016d01.tab

$TABLE NUM ID  KA CL VC=V2 ADMKA COVADMKA  ETAS(1:LAST)
NOPRINT NOAPPEND ONEHEADER FILE=1a016d01par.tab
