$PROBLEM From bbr: see 1a007d01.yaml for details
...
$DATA ../../data/derived/1a007d01.csv
IGNORE = @
...
$TABLE NUM ID TIME EVID MDV BLQ NPDE PRED IPRED CWRES
NOPRINT ONEHEADERALL FILE=1a007d01.tab

$TABLE NUM ID  KA CL VC=V2  ETAS(1:LAST)
NOPRINT NOAPPEND ONEHEADER FILE=1a007d01par.tab
