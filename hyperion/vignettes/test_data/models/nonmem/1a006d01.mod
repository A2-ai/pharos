$PROBLEM From bbr: see 1a006d01.yaml for details
...
$DATA ../../data/derived/1a006d01.csv
IGNORE = @
...
NOPRINT ONEHEADERALL FILE=1a006d01.tab

$TABLE NUM  ID  KA CL VC=V2  ETAS(1:LAST)
NOPRINT NOAPPEND ONEHEADER FILE=1a006d01par.tab
